...
exports.AddUserRoles1713567000000 = void 0;
class AddUserRoles1713567000000 {
    constructor() {
        this.name = 'AddUserRoles1713567000000';
    }
    ...
    `);
        if (!roleColumnExists[0].exists) {
            ...
            await queryRunner.query(`ALTER TABLE users ADD COLUMN role user_role NOT NULL DEFAULT 'customer'`);
        }
...
exports.AddUserRoles1713567000000 = AddUserRoles1713567000000;
