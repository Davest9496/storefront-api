...
async function setupDatabase() {
    ...
    `;
        ...
        logger_1.default.info('Setting up database schema...');
    ...
    `;
        ...
        logger_1.default.info('Seeding database with initial data...');
        await client.query(seedSql);
        // Commit the transaction
        await client.query('COMMIT');
        logger_1.default.info('✅ Database setup and seeding completed successfully');
    }
    catch (error) {
        // Rollback on error
        await client.query('ROLLBACK');
        logger_1.default.error('❌ Error setting up database:', error);
        throw error;
    }
    finally {
        // Close connection
