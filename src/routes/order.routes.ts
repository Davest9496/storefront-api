 ...
 *         description: Server error
 */
router.post('/', protect, validateRequest(orderValidation.create), createOrder);
 ...
 *         description: Server error
 */
router.post('/:id/items', protect, validateRequest(orderValidation.addItem), addItemToOrder);
...
router.patch(
  ...
  protect,
  validateRequest(orderValidation.updateItem),
  updateOrderItem,
);
